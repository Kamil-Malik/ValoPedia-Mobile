...
import com.lelestacia.valorantgamepedia.data.model.local.converter.AbilityConverter
...
@Database(
    entities = [LocalMapData::class, LocalAgentData::class],
    version = 1,
    exportSchema = false
)
@TypeConverters(value = [StringConverter::class, AbilityConverter::class])
